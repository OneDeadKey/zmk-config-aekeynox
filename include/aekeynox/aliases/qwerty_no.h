...
#define DK_ACU &kp RA(EQUAL) // acute
#define DK_GRV &kp PLUS      // grave
#define DK_DIA &kp RBKT      // diaeresis
#define DK_CIR &kp RBRC      // circumflex
#define DK_TLD &kp RA(RBKT)  // tilde

#define DEAD_ACUTE      &digraph RA(EQUAL)
#define DEAD_GRAVE      &digraph PLUS
#define DEAD_DIAERESIS  &digraph RBKT
#define DEAD_CIRCUMFLEX &digraph RBRC
#define DEAD_TILDE      &digraph RA(RBKT)
...
#define SC_ADIA DEAD_DIAERESIS RS(A) // Ä
#define  C_ODIA DEAD_DIAERESIS    O  // ö
#define SC_ODIA DEAD_DIAERESIS RS(O) // Ö
#define  C_UDIA DEAD_DIAERESIS    U  // ü
#define SC_UDIA DEAD_DIAERESIS RS(U) // Ü
